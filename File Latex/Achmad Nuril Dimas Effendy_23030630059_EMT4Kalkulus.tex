...
\end{eulerprompt}
\eulerimg{17}{images/Achmad Nuril Dimas Effendy_23030630059_EMT4Kalkulus-002.png}
\begin{eulerprompt}
...
>plot2d("z",-4,6):
\end{eulerprompt}
\eulerimg{17}{images/Achmad Nuril Dimas Effendy_23030630059_EMT4Kalkulus-005.png}
\begin{eulercomment}
3. Untuk fungsi\\
\end{eulercomment}
\begin{eulerformula}
...
\end{eulerprompt}
\eulerimg{17}{images/Achmad Nuril Dimas Effendy_23030630059_EMT4Kalkulus-007.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Achmad Nuril Dimas Effendy_23030630059_EMT4Kalkulus-009.png}
\begin{eulercomment}
5. Untuk fungsi\\
\end{eulercomment}
\begin{eulerformula}
...
\end{eulerprompt}
\eulerimg{17}{images/Achmad Nuril Dimas Effendy_23030630059_EMT4Kalkulus-014.png}
...
\end{eulerprompt}
\eulerimg{17}{images/Achmad Nuril Dimas Effendy_23030630059_EMT4Kalkulus-018.png}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{17}{images/Achmad Nuril Dimas Effendy_23030630059_EMT4Kalkulus-024.png}
\begin{eulerprompt}
...
>plot2d("sin(1/x)",-5,5):
\end{eulerprompt}
\eulerimg{17}{images/Achmad Nuril Dimas Effendy_23030630059_EMT4Kalkulus-034.png}
\eulerheading{Latihan}
\begin{eulercomment}
Bukalah buku Kalkulus. Cari dan pilih beberapa (paling sedikit 5
fungsi berbeda tipe/bentuk/jenis) fungsi dari buku tersebut, kemudian
...
\end{eulerprompt}
\eulerimg{17}{images/Achmad Nuril Dimas Effendy_23030630059_EMT4Kalkulus-041.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Achmad Nuril Dimas Effendy_23030630059_EMT4Kalkulus-046.png}
\begin{eulerprompt}
>  
\end{eulerprompt}
...
\end{eulerprompt}
\eulerimg{17}{images/Achmad Nuril Dimas Effendy_23030630059_EMT4Kalkulus-085.png}
\eulerheading{Latihan}
\begin{eulercomment}
Bukalah buku Kalkulus. Cari dan pilih beberapa (paling sedikit 5
fungsi berbeda tipe/bentuk/jenis) fungsi dari buku tersebut, kemudian
...
\end{eulerprompt}
\eulerimg{17}{images/Achmad Nuril Dimas Effendy_23030630059_EMT4Kalkulus-088.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Achmad Nuril Dimas Effendy_23030630059_EMT4Kalkulus-092.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Achmad Nuril Dimas Effendy_23030630059_EMT4Kalkulus-096.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Achmad Nuril Dimas Effendy_23030630059_EMT4Kalkulus-099.png}
\begin{eulercomment}
...
>plot2d(["f(x)","df(x)"],-pi,pi,color=[blue,yellow]):
\end{eulerprompt}
\eulerimg{17}{images/Achmad Nuril Dimas Effendy_23030630059_EMT4Kalkulus-103.png}
\begin{eulerprompt}
>    
\end{eulerprompt}
...
\end{eulerprompt}
\eulerimg{17}{images/Achmad Nuril Dimas Effendy_23030630059_EMT4Kalkulus-120.png}
\begin{eulercomment}
Integral tentu
...
\end{eulerprompt}
\eulerimg{17}{images/Achmad Nuril Dimas Effendy_23030630059_EMT4Kalkulus-125.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Achmad Nuril Dimas Effendy_23030630059_EMT4Kalkulus-134.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Achmad Nuril Dimas Effendy_23030630059_EMT4Kalkulus-140.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Achmad Nuril Dimas Effendy_23030630059_EMT4Kalkulus-147.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Achmad Nuril Dimas Effendy_23030630059_EMT4Kalkulus-151.png}
...
>plot3d("f", -3,3, -3,3) :
\end{eulerprompt}
\eulerimg{17}{images/Achmad Nuril Dimas Effendy_23030630059_EMT4Kalkulus-163.png}
\begin{eulercomment}
...
\end{eulerformula}
\begin{eulerprompt}
>function f(x,y,z)&= sqrt(x)+y^4+7*x*z
\end{eulerprompt}
\begin{euleroutput}
...
\end{eulerformula}
\begin{eulerprompt}
>function g(x,y) &= x^5+8*y^2-9*x+2
\end{eulerprompt}
\begin{euleroutput}
...
\begin{eulerformula}
\[
\frac{3sin(x)^5}{sin(x)+cos(x)}+tan (y)^4
\]
\end{eulerformula}
\begin{eulercomment}
tentukan df/dx, df/dy, dan df/dz!
\end{eulercomment}
\begin{eulerprompt}
...
\begin{eulerformula}
\[
\frac{15\,\cos x\,\sin ^4x}{\cos z+\sin x}-\frac{3\,\cos x\,\sin ^5  x}{\left(\cos z+\sin x\right)^2}
\]
\end{eulerformula}
\begin{eulerprompt}
>$fy := diff(f(x,y,z),y)
...
\begin{eulerformula}
\[
\frac{3\,\sin ^5x\,\sin z}{\left(\cos z+\sin x\right)^2}
\]
\end{eulerformula}
\eulerheading{Grafik }
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Achmad Nuril Dimas Effendy_23030630059_EMT4Kalkulus-170.png}
\begin{eulerprompt}
>title("Kontur z = 2x + 3y"):
\end{eulerprompt}
\eulerimg{17}{images/Achmad Nuril Dimas Effendy_23030630059_EMT4Kalkulus-171.png}
\begin{eulercomment}
Paraboloid z = x\textasciicircum{}4 + y\textasciicircum{}4
\end{eulercomment}
\begin{eulerprompt}
>plot3d("x^4 + y^4", -4,2, -4,2):
\end{eulerprompt}
\eulerimg{17}{images/Achmad Nuril Dimas Effendy_23030630059_EMT4Kalkulus-172.png}
\begin{eulercomment}
...
\end{eulerformula}
\begin{eulerprompt}
>plot3d("x^3 - y^3", -3,3, -3,3):
\end{eulerprompt}
\eulerimg{17}{images/Achmad Nuril Dimas Effendy_23030630059_EMT4Kalkulus-174.png}
\begin{eulercomment}
z = sin(sqrt(x\textasciicircum{}2 + y\textasciicircum{}2))
\end{eulercomment}
\begin{eulerprompt}
>plot3d("sin(sqrt(x^2 + y^2))", -4*pi,4*pi, -4*pi,4*pi):
\end{eulerprompt}
\eulerimg{17}{images/Achmad Nuril Dimas Effendy_23030630059_EMT4Kalkulus-175.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Achmad Nuril Dimas Effendy_23030630059_EMT4Kalkulus-176.png}
...
\end{eulerprompt}
\eulerimg{17}{images/Achmad Nuril Dimas Effendy_23030630059_EMT4Kalkulus-177.png}
\begin{eulerprompt}
>f &= x^2 + y^3
\end{eulerprompt}
\begin{euleroutput}
...
\begin{eulerformula}
\[
-\int_{2}^{5}{\frac{8\,y^5+1}{8}-\frac{24\,y^5+6561}{8}\;dy}=7647
\]
\end{eulerformula}
\begin{eulercomment}
Hasil dari integral ganda ini akan memberikan nilai total area di
bawah permukaan fungsi\\
f(x,y)=x\textasciicircum{}7+y\textasciicircum{}5 di daerah persegi yang ditentukan.
\end{eulercomment}
\begin{eulerprompt}
...
\begin{eulerformula}
\[
-\frac{\int_{1}^{2}{49\,y^2-18\,y\;dy}}{14}=-\frac{131}{21}
\]
\end{eulerformula}
\begin{eulercomment}
...
\end{eulerformula}
\begin{eulercomment}
Integral Ganda: Fungsi Trigonometri
...
\begin{eulerformula}
\[
\int_{2}^{3}{\frac{18\,y^7+512}{9}-3\,y^7-2187\;dy}=-\frac{210113}{  72}
\]
\end{eulerformula}
\begin{eulercomment}
\begin{eulercomment}
...
\begin{eulerformula}
\[
-\int_{1}^{2}{\frac{12\,y^3-2048}{3}-\frac{6\,y^3-243}{2}\;dy}=  \frac{6689}{12}
\]
\end{eulerformula}
\begin{eulercomment}
